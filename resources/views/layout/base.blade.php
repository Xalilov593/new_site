                ...
                <li class="dropdown"><a href="#" data-toggle="dropdown"
                    ...
                    <div class="dropdown-menu dropdown-menu-right pullDown">
                        ...
                        <form action="{{route('logout')}}" method="post">
                            @csrf
                            <button class="dropdown-item has-icon text-danger" type="submit"><i class="fas fa-sign-out-alt"></i>Logout</button>
                        </form>
                    </div>
                </li>
            </ul>
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="index.html"> <img alt="" src="/project/assets/img/logo.png" class="header-logo"/> <span
                ...
                <ul class="sidebar-menu">
                    ...
                    <?php
                        $color = 'active';
                        $rt = \Illuminate\Routing\Route::current()->getName();
                    ?>

                    <li class="dropdown <?php  if($rt == 'postCreate') echo $color;  ?>">
                        <a href="{{route('posts.create')}}" class="nav-link"><i data-feather="feather"></i><span>Posts</span></a>
                    </li>
                    <li>
                        <a class="nav-link" href="{{route('categories.index')}}"><i data-feather="layout"></i><span>Category</span></a>
                    </li>
                    <li>
                                <a class="nav-link" href="{{route('secondcategories.index')}}"><i data-feather="grid"></i><span>Status</span></a>
                    </li>
                    <li>
                    <a  class="nav-link" href="{{route('posts.index')}}"><i data-feather="grid"></i><span>Return News</span></a>
                    </li>
                </ul>
            </aside>
        </div>
